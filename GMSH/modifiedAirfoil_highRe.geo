...
Point(99) = {Lx_minus, Ly_minus, -0.500000, wall_cl};
Point(100) = {Lx_minus, Ly_plus, -0.500000, wall_cl};
Point(101) = {Lx_plus, Ly_plus, -0.500000, wall_cl};
Point(102) = {Lx_plus, Ly_minus, -0.500000, wall_cl};
...
Physical Surface("overPatch") = {212, 216, 220, 224}; 
...
Field[1].hfar = 1.11e-03; 
Field[1].hwall_n = 1.95e-06; 
Field[1].thickness = 1.04e-02; 
Field[1].ratio = 1.12; 
Field[1].AnisoMax = 10; 
Field[1].Quads = 1; 
